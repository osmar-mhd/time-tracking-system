...
// Comentar el code
// Como actua lo de las horas
// como generar un ejecutable
// windows server 2019
// Obtener los datos del registro de entrada
// Conversor en PHP 
namespace ChecadorServiceBPLT
{
    public partial class GetRecords : ServiceBase
    {
        ...
        {
            base.OnStart(args);
            DateTime today = DateTime.Today.AddHours(22).AddMinutes(10); // Define el tiempo: Se activa a las 22:10 
