...
{
    [RunInstaller(true)]
    public partial class _ServiceInstallercs : System.Configuration.Install.Installer
    {
        public _ServiceInstallercs()
        {
            InitializeComponent();
            ...
            serviceInstaller.Description = "Transfiere la información del checador a la BD DIET";
